...
public class Loan {
	  ...
	  public Loan(double annualInterestRate, int numberOfYears,
		  ...
		  //Judge the value and if true throws IllegalArgumentException
		  if(annualInterestRate <= 0 ){
			  throw new IllegalArgumentException("The Annual Interest Rate must be positive.");
		  }
		  if(numberOfYears <= 0 ){
			  throw new IllegalArgumentException("The Number Of Years must be positive.");
		  }
		  if(loanAmount <= 0){
